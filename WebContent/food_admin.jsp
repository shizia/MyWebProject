...
<body >
		...
		while(results.next()){
			...
			products.put(results.getString("foodid"), new Product(results.getString("foodid"), results.getString("foodname"),results.getString("fooddescribe"),results.getDouble("foodprice")));
...
<h2 style="margin-left: 10%;">食品区</h2>
			...
			<table style="width: 80%;margin-left: 10%;" border="1" >
				<tr bgcolor="#CCCCCC">
					...
					%><tr>
						...
						<a style="color:rgba(92, 86, 86, 0.9)" href="delete.jsp?id=<%=product.getId()%>&action=fooddelete" target="delete">删除</a>
		...
		<h2 style="margin-left: 10%;">添加食品</h2>
