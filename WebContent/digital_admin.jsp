...
<body >
		...
		while(results.next()){
			...
			products.put(results.getString("digitalid"), new Product(results.getString("digitalid"), results.getString("digitalname"),results.getString("digitaldescribe"),results.getDouble("digitalprice")));
...
<h2 style="margin-left: 10%;">数码区</h2>
			...
			<table style="width: 80%;margin-left: 10%;" border="1" >
				<tr bgcolor="#CCCCCC">
					...
					%><tr>
						...
						<a style="color:rgba(92, 86, 86, 0.9)" href="delete.jsp?id=<%=product.getId()%>&action=digitaldelete" target="delete">删除</a>
		...
		<h2 style="margin-left: 10%;">添加数码产品</h2>
